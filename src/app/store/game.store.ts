...
export class GameStoreService {
  ...
  */
  // Meta Data Observables
    public readonly $containers = toObservable(this.state.$containers.asReadonly());
    public readonly $schools = toObservable(this.state.$schools.asReadonly());
    public readonly $userProfile = toObservable(this.state.$userProfile.asReadonly());
    public readonly $sessionInfo = toObservable(this.state.$sessionInfo.asReadonly());
    public readonly $loginData = toObservable(this.state.$loginData.asReadonly());
    public readonly $gameSession = toObservable(this.state.$gameSession.asReadonly());
  ...
  */
    ...
    setDefaultGameContainer() {
      this.state.$containers.set({game: {schools: {active: true}, play: {active: false}}});
    }
