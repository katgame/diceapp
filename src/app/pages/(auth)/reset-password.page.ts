                ...
                <form class="mt-4 space-y-4 lg:mt-5 md:space-y-5" action="#">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="newsletter" class="font-light text-gray-500 dark:text-gray-300">I accept the <a class="font-medium text-blue-600 hover:underline dark:text-blue-500" href="/terms">Terms and Conditions</a></label>
                        </div>
                    </div>
