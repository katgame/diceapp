              ...
              <form class="space-y-4 md:space-y-6" action="#">
                  ...
                  <div class="flex items-start">
                      ...
                      <div class="ml-3 text-sm">
                        <label for="terms" class="font-light text-gray-500 dark:text-gray-300">I accept the <a class="font-medium text-blue-600 hover:underline dark:text-blue-500" href="/terms">Terms and Conditions</a></label>
                      </div>
                  </div>
...
export default class SignUpComponent {
    //private readonly service = inject(AuthGuard);
    constructor() {
