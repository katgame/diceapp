...
import { redirectIfLoggedInServerGuard } from '../../guards/auth.guard';
        ...
        >
          ...
          >
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6"  [formGroup]="loginForm">
                <div>
                  <label
                    for="email"
                  ...
                  <input
                    ...
                    required=""
                    [formControlName]="fields.email"  [id]="fields.email"
                  />
                </div>
                <div>
                  <label
                  ...
                  <input
                    ...
                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    required=""
                    [formControlName]="fields.password"  [id]="fields.password"
                  />
                </div>
...
export default class LoginComponent {
  ...
  roles: string[] = [];
  constructor(
    private authService: DiceService,
    private tokenStorage: TokenStorageService,
    private router: Router,
    private playerStore: GameDataStoreService
  ) {}
      ...
      .subscribe(
        (data) => {
          ...
          if (data == null) {
            ...
            this.playerStore.setPlayerInformation(data);
